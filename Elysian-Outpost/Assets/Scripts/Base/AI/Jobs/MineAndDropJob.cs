...
{
    public class MineAndDropJob
    {
        private CitizenEntity _citizenEntity;
        private NavMeshAgent _navMeshAgent => _citizenEntity._navMeshAgent;
        private TerrainHolder _terrainHolder;
        private Voxel _voxel;
        public MineAndDropJob(CitizenEntity citizenEntity, TerrainHolder terrainHolder)
        {
            _citizenEntity = citizenEntity;
        ...
        private void SetMiningState()
        {
            ...
            _citizenEntity.StartCoroutine(DelayedSetMovingToDropOffState());
        }
